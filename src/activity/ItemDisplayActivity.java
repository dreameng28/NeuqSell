	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		query.getObject(this, itemID, new GetListener<UserItem>() {
			...
			public void onSuccess(UserItem arg0) {
				...
				commentEditText = (EditText) findViewById(R.id.comment_content_et);
				commentListView = (ListView) findViewById(R.id.item_comment_lv);
...
//				});
				...
				sendComment.setOnClickListener(ItemDisplayActivity.this);
				...
				if(arg0.getItemPic4() != null){
					Picasso.with(getBaseContext()).load(arg0.getItemPic4()).into(itemPic4);
					addPicFlag = 3;
				}
				if(arg0.getItemPic5() != null){
					Picasso.with(getBaseContext()).load(arg0.getItemPic5()).into(itemPic5);
					addPicFlag = 4;
				}
...
//					itemPic4 = (ImageView) findViewById(R.id.my_display_item_pic4);
//					itemPic5 = (ImageView) findViewById(R.id.my_display_item_pic5);
//					Picasso.with(getBaseContext()).load(arg0.getItemPic()).into(itemPic);
//					if(arg0.getItemPic2() != null){
//						Picasso.with(getBaseContext()).load(arg0.getItemPic2()).into(itemPic2);
//						addPicFlag = 1;
...
//				});
				...
				currentUser.update(ItemDisplayActivity.this, currentUser.getObjectId(), new UpdateListener() {
					...
					public void onSuccess() {
						// TODO Auto-generated method stub
						Toast.makeText(ItemDisplayActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
					}
...
//				mUserItem.setCollectionNum(collectionNum);
				...
				mUserItem.update(this, itemID, new UpdateListener() {
					...
					public void onSuccess() {
						// TODO Auto-generated method stub
//						Toast.makeText(ItemDisplayActivity.this, "取消收藏成功", Toast.LENGTH_SHORT).show();
					}
		...
		case R.id.send_comment:
			final ItemComment mItemComment = new ItemComment();
			mItemComment.setCommentUserInfo(currentUser);
			mItemComment.setCommentUserItem(mUserItem);
			mItemComment.setComment(commentEditText.getText().toString());
			mItemComment.save(this, new SaveListener() {
				
				@Override
				public void onSuccess() {
					// TODO Auto-generated method stub
					BmobRelation itemOrMycomments = new BmobRelation();
					itemOrMycomments.add(mItemComment);
					mUserItem.setItemComments(itemOrMycomments);
					currentUser.setMyComments(itemOrMycomments);
					mUserItem.update(ItemDisplayActivity.this, itemID, new UpdateListener() {
...
//			break;
		...
		case R.id.delete_item:
			...
			mUserItem.delete(this, new DeleteListener() {
				...
				public void onSuccess() {
					// TODO Auto-generated method stub
					Toast.makeText(ItemDisplayActivity.this, "成功删除商品", Toast.LENGTH_SHORT).show();
				}
				...
				public void onSuccess() {
					...
					newUserItem.update(ItemDisplayActivity.this, itemID, new UpdateListener() {
						...
						public void onSuccess() {
							...
							Toast.makeText(ItemDisplayActivity.this, "成功添加了一张图片", Toast.LENGTH_SHORT).show();
						}
...
//    }  
	...
	private class CommentAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(mItemComment.getCommentUserInfo().getGender().equals("男")){
			...
			if(position == 0){
				viewHolder.floorNum.setText("沙发");
			}
			
			if(position == 1){
				viewHolder.floorNum.setText("板凳");
			}
